...
public class RecipesDao {
	...
	public static void createRecipe(int user_id, String ingredients, String instructions, String name)
			throws SQLException {
		String sql = "INSERT INTO recipes (name, ingredients, instructions, user_id) VALUES (?, ?, ?, ?)";
	...
	public static void modifyRecipe(String instructions, String name, String ingredients, int recipes_id)
			throws SQLException {
